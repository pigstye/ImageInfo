...
#>
	...
	begin {
		out-debut "Checking $logfile for gaps in record ID"
		$BoundaryEvents = @()
	}
...
#>
	...
	out-debut "Searching log: $csvdir$computername~security.csv"
	...
	$report = @()
	out-debut "Searching log: $computername~lolbins.csv"
	...
	out-debut "Searching log: $computername ~logonEvents.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-TerminalServices-LocalSessionManager%4Operational.csv"
	...
	$report = @()
	out-debut "Searching log: $computername~TerminalServicesLogins.csv"
	...
	out-debut "Searching log: $csvdir$computername~system.csv"
	...
	out-debut "Searching log: $csvdir$computername~application.csv"
	...
	out-debut "Searching log: $computername~applicationcrash.csv"
	...
	out-debut "Searching log: $csvdir$computername~Windows PowerShell.csv"
	$t = import-csv ($csvdir + ($computername + '~Windows PowerShell.csv'))
	[System.GC]::Collect()
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-PowerShell%4Operational.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-Shell-Core%4Operational.csv"
	...
	out-debut "Searching log: $csvdir$computername~OAlerts.csv.csv"
	...
	out-debut "Searching log: $csvdir$computername~~Microsoft-Windows-AppLocker%4EXE and DLL.csv"
	import-csv ($csvdir + ($computername + '~Microsoft-Windows-AppLocker%4EXE and DLL.csv')) | export-csv -notype ($computername + '~applocker.csv')
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-AppLocker%4MSI and Script.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-AppLocker%4Packaged app-Deployment.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-AppLocker%4Packaged app-Execution.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-WinRM%4Operational.csv"
	...
	out-debut "Searching log: $csvdir$computername~Microsoft-Windows-TaskScheduler%4Operational.csv"
	...
	out-debut 'Searching for Windows Defender malware detections'
...
[Parameter(Mandatory=$True)][string]$csvdir)
	...
	out-debut "Looking for Common Vulnerabilites"
